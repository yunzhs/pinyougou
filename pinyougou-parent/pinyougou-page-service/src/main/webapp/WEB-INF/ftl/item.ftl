...
<head>
    ...
    <script type="text/javascript">
        ...
        <#list itemList as item>
            {'id':${item.id?c}, 'title': '${item.title}', 'price':${item.price?c}, 'spec':${item.spec}},
...
<body ng-app="pinyougou" ng-controller="itemPageController" ng-init="num=1;loadSku()">
<#include "head.ftl">

<#-- 转化图片列表 -->
<#assign imageList=goodsDesc.itemImages?eval>
<#-- 转化扩展属性列表 -->
<#assign attributeList=goodsDesc.customAttributeItems?eval>
<#-- 转化规格列表 -->
    ...
    <div id="item">
        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px"
                                                  height="400px"/></span>
                    </div>
                    <!--下方的缩略图-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news">${goodsDesc.introduction}</div>
                <div class="summary">
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            ...
                            <#list attributeList as attribute>
                                <li>${attribute.text}：${attribute.value}</li>
                            </#list>

                            </ul>
                            <div class="intro-detail">
                                <img jqimg="${goodsDesc.packageList}" src="${goodsDesc.packageList}"/>
                            </div>
                        </div>
